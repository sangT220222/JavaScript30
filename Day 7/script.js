...
const check = people.some(person => ((new Date().getFullYear()) - person.year >= 19));
console.log(check);

// Array.prototype.every() // is everyone 19 or older?
const check_every = people.every(person=> ((new Date().getFullYear) - person.year >= 19));
console.log(check_every);

// Array.prototype.find()
// Find is like filter, but instead returns just the one you are looking for
// find the comment with the ID of 823423
const check_ID = comments.find(comment => comment.id === 823423);
